...
# Version: 1.8
# Source: https://github.com/Bain/code-red-base/blob/main/scripts/log.bash
#
...
#   https://patorjk.com/software/taag/#p=display&f=ANSI+Shadow&t=Roof+Survey
#
# -----------------------------------------------------------------------------------------------------------
log_banner() {
    ...
    ██║  ██║╚██████╔╝╚██████╔╝██║         ${RED}███████║╚██████╔╝██║  ██║ ╚████╔╝ ███████╗   ██║   ${RESET}
    ╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚═╝         ${RED}╚══════╝ ╚═════╝ ╚═╝  ╚═╝  ╚═══╝  ╚══════╝   ╚═╝   ${RESET}
                                                 .. a ${RED}Bain${RESET} Code Red Innovation Project
    "
